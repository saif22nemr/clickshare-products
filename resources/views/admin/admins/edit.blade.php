...
@section('title', trans('app.edit') . ' ' . trans('app.admin'))
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong>{{ trans('app.edit') }} {{ trans('app.admin') }}</strong>
                </div>
                    ...
                    <form action="{{ route('admin.admin.update' , $admin->id) }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="first_name" value="{{ old('first_name' , $admin->first_name) }}"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="last_name" value="{{ old('last_name' , $admin->last_name) }}"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="email" value="{{ old('email' , $admin->email) }}"
