...
@section('title', trans('app.edit') . ' ' . trans('app.manager'))
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong>{{ trans('app.edit') }} {{ trans('app.manager') }}</strong>
                </div>
                    ...
                    <form action="{{ route('admin.manager.update' , $manager->id) }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="first_name" value="{{ old('first_name' , $manager->first_name) }}"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="last_name" value="{{ old('last_name' , $manager->last_name) }}"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="email" value="{{ old('email' , $manager->email) }}"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col col-md-9">
                                <div class="form-check-inline form-check">
                                    @php
                                        $selectedDepartments = old('departments' , $manager->departments->pluck('id')->toArray() ?? []);
                                    @endphp
