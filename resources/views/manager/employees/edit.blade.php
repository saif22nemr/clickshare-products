...
@section('title', trans('app.edit') . ' ' . trans('app.employee'))
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong>{{ trans('app.edit') }} {{ trans('app.employee') }}</strong>
                </div>
                <div class="card-body card-block">
                    <form action="{{ route('manager.employee.update' , $employee->id) }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="first_name" value="{{ old('first_name' , $employee->first_name) }}"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="last_name" value="{{ old('last_name' , $employee->last_name) }}"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="email" value="{{ old('email' , $employee->email) }}"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="salary" value="{{ old('salary' , $employee->salary) }}"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col col-md-9">
                                <div class="form-check-inline form-check">
                                    @php
                                        $selectedDepartments = old('departments' , $employee->departments->pluck('id')->toArray() ?? []);
                                    @endphp
