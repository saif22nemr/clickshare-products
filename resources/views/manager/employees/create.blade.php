...
@section('title', trans('app.create') . ' ' . trans('app.employee'))
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong>{{ trans('app.create') }} {{ trans('app.employee') }}</strong>
                </div>
                <div class="card-body card-block">
                    <form action="{{ route('manager.employee.store') }}" method="post" enctype="multipart/form-data"
