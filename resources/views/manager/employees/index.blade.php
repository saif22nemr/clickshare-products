...
@section('title', trans('app.employee'))
@push('styles')
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="buttons">
                <a href="{{ route('manager.employee.create') }}" class="btn btn-primary">{{ trans('app.create') }}
                    {{ trans('app.employee') }}</a>
            </div>
            <div class="card">
                <div class="card-header">
                    <strong> {{ trans('app.employees') }}</strong>
                </div>
                                    ...
                                    <tr class="tr-shadow" id="row-{{ $emp->id }}">
                                        ...
                                        <td>
                                            <div class="table-data-feature">
                                                ...
                                                <a class="item" href="{{ route('manager.employee.edit', $emp->id) }}"
                                                    data-toggle="tooltip" data-placement="top" title="Edit">
                                                    <i class="zmdi zmdi-edit"></i>
                                                </a>
                                                <button class="item delete-item" data-toggle="tooltip" data-placement="top"
                                                    data-url="{{ route('manager.employee.destroy', $emp->id) }}"
